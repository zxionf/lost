...
//            String b = Main.ass.getAssetNames().get(Main.ass.getAssetNames().size-1);
//            font.draw(batch,MyGdxGame.ass.getAssetNames()MyGdxGame(Main.ass.getAssetNames().size-1), Gdx.graphics.getWidth()/ 2 - 160, 132);
//        }
        batch.end();
