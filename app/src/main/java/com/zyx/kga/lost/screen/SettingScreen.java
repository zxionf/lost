...
public class SettingScreen extends AbstractScreen {
    ...
    public SettingScreen(final MyGdxGame game) {
        ...
        sliderstyle.knob = new TextureRegionDrawable(new TextureRegion(RectangleTexture(18,36)));
    ...
    private void addKuangTi() {
        ...
        final Slider slider1_0 = new Slider(0.1f, 2f, 0.1f, false,sliderstyle);
...
//        pixmap.fillRectangle(4,4,pixmap.getWidth()-8,pixmap.getHeight()-8);
        ...
        //pixmap.setColor(0xff0 0ffcc);                                    
        pixmap.fillRectangle(4, 4, pixmap.getWidth() - 8, pixmap.getHeight() - 8);
        Texture texture = new Texture(pixmap);                               
        pixmap.dispose();
        return texture;
    }
    private static Texture RectangleTexture(int weight,int height) {
        Pixmap pixmap = new Pixmap(weight,height, Pixmap.Format.RGBA8888);
//        pixmap.setColor(0x000000cc);
//        pixmap.fillRectangle(0,0,pixmap.getWidth(),pixmap.getHeight());
//        pixmap.setColor(0xffffffaa);
